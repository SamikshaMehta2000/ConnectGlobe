 ...
 <div id="middle">
   ...
   <div id="loginform">
    	<form action="Aloginprocess.jsp" method="post">
    		<table>
    		<tr>
	    		<td><div id="log" style="position: relative;top:-38px">
	    		<img id="logimg" style="border-radius: 20px" src="image/log.jpg">
	    		<h1 style="color:white;padding-left:60px;position: relative;left:28px"><font color="white" style="position: relative;top: 17px;">LOGIN</font>
	    		</h1>
	  			 </div></td>
   			</tr>
    	...
    	<tr><td><input type="submit" value="login" class="btn" class="read-article" style="position: relative;top:-13px;"></td></tr>
...
<div id="latestNews" style="left: 462px">
    	...
    	<h1 style="color:white;" >
    			<font color="white" style="postion:relative;top:19px; " id="ln">LATEST NEWS</font>
    	</h1>
