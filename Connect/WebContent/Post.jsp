...
<body>
 ...
 <section class="aw-accordion">
    ...
    <ul>
	    ...
	    <li><a href="Post.jsp" style="color:white">POST REPORT</a></li>
...
<div id="top">
 ...
 <div id="basic">
 	<h1 style="font-size:18px;position:relative;top:33px;">
 			Post your report here and upload a picture. </h1>
 </div>
 ...
 <div id="container">
 			 <%
 			   ...
 			   {
 			         out.print("<font color='orange' size='2'style='top:-73px'>");
 					 out.print(request.getAttribute("error"));
 					 out.print("</font>");
 				}
 					 
 			 if(request.getAttribute("picuploaded")!=null)
	 			 {
	 				 out.print("<font color='orange' size='2' style='top:-73px'>");
					 out.print(request.getAttribute("picuploaded"));
					 out.print("</font>");  
	 			 }
 					  %>
 					  <br>
 	 <h1 style="position: relative;left:18pc;top:-73px">POST REPORT</h1>
 					 
  <form action="Uploadimage.jsp" id="loginform" method="post" style="position:relative;top:-63px;">
 				<br>
 	<table>
 				<tr>
	 			    <td>Country:</td>
 			...
 			<br>
 				Your report:
 				<textarea rows="10" cols="100" name="report" style="background-color:#90a4ae"></textarea>
 			<br>
 			<br>
 			    <input type="submit" class="btn" value="submit" style="position: relative;left:312px">
</form>

</div>
 						
<div id="footer">
				<p style="color:#191d21;position:relative;bottom: -333px;">
						created by SAMIKSHA 
				</p>
</div> 
