...
<section class="aw-accordion">
		<img  id="logo" alt="" src="https://th.bing.com/th/id/OIP.7gWiYfwII2mtyWMGkrRS7AHaHa?w=202&h=202&c=7&o=5&pid=1.7">
   		 <h1>CONNECT GLOBE 
   		  <a href="Logout.jsp" class="read-article" id="login">LOGOUT</a>
   		</h1>
 ...
 <div id="nav" class="read-article">
						...
						<li><a href="Discuss.jsp" style="color:white;">DISCUSS</a></li>
					 </ul>
 </div>
...
<div id="basic">
			...
			It is very important to voice your opinions, especially when it comes to critical issues like cyber security. </h1>
</div>
 
<div id="container" style="position: relative;top: 194px;">
 			 <center><img alt="" style="display: inline-block;position: relative;width: 36px;left: 285px;height: 27px;" src="https://th.bing.com/th/id/OIP.zTX35caHFCabjWT0rAuYoAHaHa?w=201&h=202&c=7&o=5&pid=1.7">   
 ...
 <script type="text/javascript">
				  ...
				  //script for information loading
	  ...
	  $.get("Alladvccmts.jsp",{n:name},function(dataa){
		  $(d).html(dataa);
				   ...
				   function post(n){
				 	   ...
				 	   var id="#"+n+"abc";
				 		   $(id).html("<form action='Postcmttopic.jsp' id='loginform'><input type='text'  name='id' style='display:none' value='"+n+"'><textarea style='background-color:#90a4ae;' rows=5 cols=110 name='cmt'/><br><input type='submit' class='btn' style='color:#c9d6e2' value='comment'/></form> ");
				 	   }
