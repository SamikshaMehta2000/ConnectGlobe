...
<section class="aw-accordion">
    	...
    	<h1>CONNECT GLOBE
  		 ...
  		 <a href="Register.jsp" class="read-article" id="login">REGISTER NOW</a></h1>
 <div id="nav" class="read-article">
		   <ul>
			    ...
			    <li><a href="HomeDiscuss.jsp" style="color:white;">DISCUSS</a></li>
...
<div id="basic">
	<h1 style="font-size:18px;position:relative;top:33px;">Now You can Share Your Social Problem such as some kind of Harassment,Bribe matters.
								Simply just Register Yourself and Do login After that click on Post Report Link as shown above.And After selecting Your subject and location YOu can post Your matter Simply .This will be visible to every visitors and our Supporters will try to proceed it further</h1></div>
 
 		<div id="container" style="position: relative;top: 194px;">
 			 <center><img alt="" style="display: inline-block;position: relative;width: 36px;left: 285px;height: 27px;" src="https://th.bing.com/th/id/OIP.zTX35caHFCabjWT0rAuYoAHaHa?w=201&h=202&c=7&o=5&pid=1.7">   <h1>CREATE A TOPIC</h1></center>
 				    <%
 				    ...
 				    %>
 				   <h1>If you want to create new topic or join the discussion on already existing topics, you need to register and login first.</h1>
 		 <form id="loginform" action="CreateTopic.jsp">
 				 <br>
 			 <table>
 			 	<tr>
 			 		<td>Enter topic:</td>
 			    ...
 			    <tr>
 			    	<td><input type="submit"  class="btn" value="create topic"/></td>
 			    </tr>
 			</table>
 		 </form>
 				   
 			 <br>
 				 <a href="#" id='topics' style="text-decoration: none;"><font color="orange" size="4">View all previously created topics</font></a>
 	 ...
 	 <script type="text/javascript">
				  ...
				  $(document).ready(function(){
					 $("#topics").click(function(){
						 $.get("Alltopic.jsp",function(d){
							 $("#information").html(d);
						 })
					 }) ;
				  });
				
				  //script for information loaded
				   function viewAll(name){
			      var d="#"+name;
			      
				  $.get("Alladvccmts.jsp",{n:name},function(dataa){
					  $(d).html(dataa);	
						  });
					  }
				   ...
				   function post(n){
				 	   ...
				 	   var id="#"+n+"abc";
				 		   $(id).html("<font size='2' color='orange'>*please register and login to join the conversation.</font>");
				 	   }
