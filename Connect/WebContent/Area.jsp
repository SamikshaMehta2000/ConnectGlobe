...
<section class="aw-accordion">
     ...
     <div id="nav" class="read-article">
						...
						<li><a href="Area.jsp" style="color:white;">YOUR AREA</a></li>
 ...
 <div class="three">
  ...
  <div class="four" style="  background-color:#9ea036;"> 
	...
	<div id="basic">
					...
					Now you can browse through reports of your country.<br>Just type the city to view reports posted there</h1>
	</div>
...
<script type="text/javascript">
  //CODE FOR KEYUP ON CITY
     	 $(document).ready(function(){
     		$("#city").on("keyup",function(){
     			
     			$.get("Findcity.jsp",{city:$("#city").val()},function(data){
     				$("#reports").html(data);
     			});
     		}) ;
     	 });
